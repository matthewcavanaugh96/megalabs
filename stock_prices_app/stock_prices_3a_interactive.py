...
st.write("""
This version will only contain stocks that were in S&P 500 as of August 25, 2026. This will only constitute 468 stocks as some were dropped during data cleaning.
""")

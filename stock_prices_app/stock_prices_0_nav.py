...
test_page = st.Page("stock_prices_99_test.py", title="Future ideas and experiments", icon="🧪")


# Set up navigation
nav = st.navigation([home, eda, interactive, mod_overview, mod_results, mod_comp, test_page])
nav.run()
